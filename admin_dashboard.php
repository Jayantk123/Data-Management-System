...
<body>
	<div id="header"><br>
		<center>IT Solutions Data Management System &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email: <?php echo $_SESSION['email'];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:<?php echo $_SESSION['name'];?> 
	...
	<div id="left_side">
		...
		<form action="" method="post">
			<table>
				<tr>
					<td>
						<input class="but" type="submit" name="search_client" value="Search Client">
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td>
						<input class="but" type="submit" name="edit_client" value="Edit Client Data">
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td>
						<input class="but" type="submit" name="add_new_client" value="Add New Client">
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td>
						<input  class="but" type="submit" name="delete_client" value="Delete Client Data">
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td>
						<input class="but" type="submit" name="show admins" value="Show Admins">
					</td>
				</tr>
			</table>
		</form>
		...
		<!-- #Code for search student---Start-->
			<?php
				if(isset($_POST['search_client']))
				{
					...
					<h4><b><u>Client's details are :-</u></b></h4><br><br>
					</center>
					<?php
				}
				if(isset($_POST['search_by_roll_no_for_search']))
				{
					$query = "select * from students where id_no = '$_POST[id_no]'";
		...
		<?php
			...
			<?php
				if(isset($_POST['show_admins']))
				{
					?>
					<center>
						<h5>Admin's Details</h5>
						<table>
							<tr>
								<td id="td"><b>ID</b></td>
								<td id="td"><b>Name</b></td>
								<td id="td"><b>Mobile</b></td>
								<td id="td"><b>Roles</b></td>
					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table style="border-collapse: collapse;border: 1px solid black;">
							<tr>
								...
								<td id="td"><?php echo $row['roles']?></td>
